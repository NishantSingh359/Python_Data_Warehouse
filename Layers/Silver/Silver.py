...
if __name__ == "__main__":
    ...
    try:
        ...
        ingredients =   pd.read_pickle(r"./Layers/silver/erp/ingredients.pkl")
    ...
    try:
        ...
        customers =      pd.read_pickle(r"./Layers/silver/crm/customers.pkl")
        ...
        partners =       pd.read_pickle(r"./Layers/silver/erp/delivery_partners.pkl")
    ...
    try:
        ...
        menu =          pd.read_pickle(r"./Layers/silver/erp/menu_items.pkl")
