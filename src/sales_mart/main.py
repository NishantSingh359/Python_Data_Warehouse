...
from dim.dim_items import DimMenu_items

from fact.fact_sales import FactSales

logging.basicConfig(
    level=logging.INFO,
    filename="log/sales_mart.log",
    filemode="w",
...
if __name__ == "__main__":
    run_domain("src/sales_mart/config/dim.yaml", DIM_MAP)
    run_domain("src/sales_mart/config/fact.yaml", FACT_MAP)
