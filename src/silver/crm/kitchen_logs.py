...
class Kitchen_logsSilver(BaseSilverPipeline):
    ...
    def clean(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        chef_id =        df['chef_id'].str.replace(r'\D','',regex=True).replace({'':np.nan,'nan':np.nan})
